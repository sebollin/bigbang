...
- Component manifests now resolve bare archive filenames from the
  supplied
- `pkg_dir` directories when the files are not beside the manifest,
  preserve absolute and `~` paths, and report every directory searched
  for a missing entry.
...
Prepared and verified but never submitted: CRAN submissions were closed
between 2026-08-05 and 2026-08-19. These changes are released as part of
0.3.0.
