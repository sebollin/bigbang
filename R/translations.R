...
.bigbang_spanish_catalog <- function() {
  c(
    ...
    "'reexport' is deprecated and ignored. Loading the generated metapackage attaches installed components, but their functions are not exported from the metapackage namespace." = "'reexport' est\u00e1 deprecado y se ignora. Cargar el metapaquete generado adjunta los componentes instalados, pero sus funciones no se exportan desde el espacio de nombres del metapaquete.",
