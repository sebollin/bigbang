...
.generated_metapackage_symbols <- function(name) {
  ...
  c(public, ".pkgs", ".component_names", ".component_specs",
    ".component_reexport_specs", ".reexport_state", ".reexport_library_paths",
    ".set_reexport_library", "attach_installed_packages",
    ...
    "read_archive_dependencies", "build_dependency_graph", "topological_order",
  ...
  content <- c(
    ...
    if (isTRUE(reexport)) {
      c(
        ...
        "Using a binding before its component is installed reports a clear error;",
        "installing the component later makes the same binding work without reload.",
